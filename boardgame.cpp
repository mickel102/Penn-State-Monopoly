...
/*****************************************************************************/
    ...
    //Community Card 3
    community[index[3]]->setCardText("Advance to The Willard Building!");
    ...
    //Community Card 5
    community[index[5]]->setCardText("Won 2nd Place at Cup Pong!");
    community[index[5]]->setAmount(20);

    //Community Card 6
    community[index[6]]->setCardText("March to the Stadium!");
    ...
    //Chance Card 3
    chance[index[3]]->setCardText("Advance to El Jefes");
    ...
    //Chance Card 6
    chance[index[6]]->setCardText("Take a trip to the White Loop");
    ...
    //Chance Card 8
    chance[index[8]]->setCardText("Advance to Blue Loop!");
