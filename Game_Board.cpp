...
Game_Board::Game_Board(){
	...
	//Space 3
	spaces[3].setName(" Pattee  ", " Library ");
	...
	//Space 6
	spaces[6].setName(" Hosler  ", "  Building   ");
	...
	//Space 9
	spaces[9].setName(" Willard  ", " Building   ");
	...
	//Space 11
	spaces[11].setName(" Sparks  ", " Building  ");
	...
	//Space 13
	spaces[13].setName("Pollock ", "  Center   ");
	...
	//Space 16
	spaces[16].setName("  Thomas  ", "  Building  ");
	...
	//Space 18
	spaces[18].setName("  Westgate   ", "  Building  ");
	...
	//Space 21
	spaces[21].setName(" Boucke  ", "Building");
	...
	//Space 26
	spaces[26].setName("Pickles ", "  Tap Room  ");
	...
	//Space 29
	spaces[29].setName(" Champs  ", " Sports Bar  ");
	...
	//Space 30
	spaces[30].setName("Caught by", " Police  ");
	...
	//Space 32
	spaces[32].setName("  College  ", " Pizza  ");
	...
	//Space 39
	spaces[39].setName("Beaver ", "Stadium ");
